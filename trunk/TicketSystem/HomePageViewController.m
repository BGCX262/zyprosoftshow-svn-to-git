...
//{
//    //组合查询参数
//    NSDictionary *paramDict = [NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%d",QUERY_SERVER_NOTI_UPDATE_TYPE],@"queryType",[[NSUserDefaults standardUserDefaults]objectForKey:@"currentRequestTime"],@"param1", nil];
//    //伪装查询
//    [[ZYNetworkHelper shareZYNetworkHelper]requestDataWithApplicationType:TicketSystemRequestQueryType withParams:paramDict withHelperDelegate:self withSuccessRequestMethod:@"getServerUpdateTimeSuccess:" withFaildRequestMethod:@"getServerUpdateTimeFaild:"];
//}
////获取服务器更新消息成功
//- (void)getServerUpdateTimeSuccess:(NSObject *)result
//{
//    NSLog(@"result %@",result);
//    //解析结果
//    NSDictionary *resultDict = (NSDictionary *)result;
//    NSDictionary *resultDictReal = [resultDict objectForKey:@"serverUpdateTag"];
//    NSInteger resultTag = [[resultDictReal objectForKey:@"tag"]intValue];
//    if (resultTag == SERVER_NOTI_UPDATE_TIME_IS_EQUAL) {
//        ifNeedUpdateNow = NO;
//        return;
//    }else if(resultTag == SERVER_NOTI_UPDATE_TIME_IS_NEW){
//        [[NSUserDefaults standardUserDefaults]setObject:[resultDictReal objectForKey:@"value"] forKey:@"currentRequestTime"];
//        ifNeedUpdateNow = YES;
//    }
//}
////获取服务器更新失败
//- (void)getServerUpdateTimeFaild:(NSObject *)result
//{
//    NSLog(@"%@",result);
//}
